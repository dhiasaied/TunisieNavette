                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    // Affichez les détails de la réservation dans un formulaire pour la confirmation de la suppression
                                    ?>
                                    <h2 class="section-title">Voulez-vous vraiment supprimer la réservation de vol suivante ?</h2>
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Billet classe affaires</th>
                                                <th>Billet classe économique</th>
                                                <th>Sous-total</th>
                                                <th>TVA</th>
                                                <th>Total</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $row['first_class_ticket_number']; ?></td>
                                                <td><?php echo $row['economy_class_ticket_number']; ?></td>
                                    ...
                                    <form action="delete_confirm_reservation.php" method="POST">
                            ...
                            <?php
                                    ...
                                    echo "Aucune réservation de vol trouvée avec cet identifiant.";
                                }
                            } else {
